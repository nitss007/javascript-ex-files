...
const OTHERCIRCLE = document.querySelector('.otherCircle');
...
function mouseCoordinates(e) {
    ...
    var otherhorizontalPosition = windowWidth - horizontalPosition - 26;
    var otherverticalPosition= windowHeight - verticalPosition - 26;
    ...
    OTHERCIRCLE.style.left = horizontalPosition + 'px';
    OTHERCIRCLE.style.top =  otherverticalPosition + 'px';
}
...
function changeColorOnTouch() {
    ...
    OTHERCIRCLE.style.backgroundColor = "red";
    OTHERCIRCLE.style.borderColor = "red";
}
...
OTHERCIRCLE.removeAttribute("style");}, false);
